...
export default function App() {
  ...
  const [meet] = useState<DLMeet>('florence23');
        ...
        {arePicksComplete ? (
          <Stack>
            ...
            >
              ...
              <TextInput withAsterisk label="Tiebreaker: Men's 5000m winning time?" placeholder="e.g. 12:38.50" {...registerForm.getInputProps('tiebreaker')} />
              ...
              <Text size="md">
                ...
                <Popover width="100%" position="bottom" withArrow shadow="md">
                  ...
                  <Popover.Dropdown>
                    ...
                    <Text mb={10}>
                      <strong>Submissions Deadline:</strong> Friday June 2, before the DL TV window starts, by 2pm ET.
                      {/* <br />
